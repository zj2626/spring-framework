...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		super();
		System.out.println("* * AnnotationConfigApplicationContext super [BeanDefinition:" + this.getBeanFactory().getBeanDefinitionCount() + " | BeanPostProcessor: " + this.getBeanFactory().getBeanPostProcessorCount() + "]");
		// 该reader只能 读取注解修饰的类转化为 BeanDefinition
		this.reader = new AnnotatedBeanDefinitionReader(this);
		System.out.println("* * AnnotationConfigApplicationContext beanFactory [BeanDefinition:" + this.getBeanFactory().getBeanDefinitionCount() + " | BeanPostProcessor: " + this.getBeanFactory().getBeanPostProcessorCount() + "]");
